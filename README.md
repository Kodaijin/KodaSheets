...
A card-sheet layout script for Adobe Photoshop. It tiles individual card images
from a folder onto print-ready sheets, pairs fronts with backs by filename, and
lays out duplex (double-sided) sheets that mirror correctly for flip alignment.

> **Note:** the GIMP 3 port has been removed for now and is being recoded from
> scratch — it will return in a future release. Only the Photoshop script is
> currently shipping.
...
_(A GIMP 3 port is being recoded and will be documented here when it returns.)_
...
The GIMP 3 Python-Fu port has been removed for now and is being recoded from
scratch. It will return, with updated install and usage instructions, in a
future release.
